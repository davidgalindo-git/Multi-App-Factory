        ...
        <div className="flex flex-col items-center justify-center w-full min-h-screen py-10 ">
          ...
          {displayProducts.length === 0 && (
            <p className="mt-4 text-center text-red-500">
              Note: This is dummy pricing data. Add your own pricing in the Stripe Dashboard to see real plans.
              Alternatively, use the Stripe fixtures command to seed pricing data.
            </p>
          )}
